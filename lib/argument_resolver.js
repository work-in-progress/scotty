(function() {
  ...
  */
  ...
  exports.ArgumentResolver = (function() {
    ...
    */
    ArgumentResolver.prototype.isAmbiguous = false;
    /** 
    An array of resources that would match the action returned.
    */
    ArgumentResolver.prototype.ambiguousResources = [];
    /**
    ...
    */
    ...
    ArgumentResolver.prototype._resolve = function() {
      ...
      if (this.loader.isResource(this.args[0])) {
        ...
        if (this.loader.isAmbiguousAction(this.args[0])) {
          this.resource = null;
          this.action = this.args[0];
          this.isAmbiguous = true;
          this.ambiguousResources = this.loader.ambiguousResourcesForAction(this.args[0]);
          if (this.isAmbiguous) {
            this.isHelp = true;
          }
        } else {
