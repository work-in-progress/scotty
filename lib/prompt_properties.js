(function() {
  ...
  PromptProperties = (function() {
    function PromptProperties() {}
    PromptProperties.prototype.email = {
      name: 'email',
    ...
    PromptProperties.prototype.password = {
      name: 'password',
      hidden: true
    };
    PromptProperties.prototype['confirm password'] = {
      name: 'confirm password',
      hidden: true
    };
    PromptProperties.prototype.inviteCode = {
      name: 'invite code',
      message: 'Invite Code',
      validator: /^\w+$/,
  ...
  module.exports.properties = new PromptProperties;
}).call(this);
