      ...
      */
      ...
      return this.config.load(__bind(function(err) {
        ...
        return utils.checkVersion(__bind(function(err) {
          ...
          return this.loader.getActionFn(this.command[0], __bind(function(err, actionFn) {
            if (err) {
              return winston.error("Command not found. Try scotty help");
            } else {
              return actionFn(args, __bind(function() {
                return winston.info("Thank you for using scotty");
              }, this));
            }
          }, this));
        }, this));
